...
validate(Str) ->
    ...
    lists:foreach(
        fun(F) ->
            lists:any(F, CharL) andalso
                error({non_valid_scram_password, Str})
        end,
        [
            fun is_non_asci_space_character/1,
...
is_non_asci_space_character(C) ->
    C == 16#00A0 orelse
        C == 16#1680 orelse
        (16#2000 =< C andalso C =< 16#200B) orelse
        C == 16#202F orelse
        C == 16#205F orelse
        C == 16#3000.
...
is_non_ascii_control_character(C) ->
    (16#0080 =< C andalso C =< 16#009F) orelse
        C == 16#06DD orelse
        C == 16#070F orelse
        C == 16#180E orelse
        C == 16#200C orelse
        ...
        C == 16#2062 orelse
        C == 16#2063 orelse
        (16#206A =< C andalso C =< 16#206F) orelse
        C == 16#FEFF orelse
        (16#FFF9 =< C andalso C =< 16#FFFC) orelse
        (16#1D173 =< C andalso C =< 16#1D17A).
...
is_private_use_characters(C) ->
    (16#E000 =< C andalso C =< 16#F8FF) orelse
        (16#F000 =< C andalso C =< 16#FFFFD) orelse
        (16#100000 =< C andalso C =< 16#10FFFD).
...
is_non_character_code_points(C) ->
    (16#FDD0 =< C andalso C =< 16#FDEF) orelse
        (16#FFFE =< C andalso C =< 16#FFFF) orelse
        (16#1FFFE =< C andalso C =< 16#1FFFF) orelse
        (16#2FFFE =< C andalso C =< 16#2FFFF) orelse
        (16#3FFFE =< C andalso C =< 16#3FFFF) orelse
        (16#4FFFE =< C andalso C =< 16#4FFFF) orelse
        (16#5FFFE =< C andalso C =< 16#5FFFF) orelse
        (16#6FFFE =< C andalso C =< 16#6FFFF) orelse
        (16#7FFFE =< C andalso C =< 16#7FFFF) orelse
        (16#8FFFE =< C andalso C =< 16#8FFFF) orelse
        (16#9FFFE =< C andalso C =< 16#9FFFF) orelse
        (16#AFFFE =< C andalso C =< 16#AFFFF) orelse
        (16#BFFFE =< C andalso C =< 16#BFFFF) orelse
        (16#CFFFE =< C andalso C =< 16#CFFFF) orelse
        (16#DFFFE =< C andalso C =< 16#DFFFF) orelse
        (16#EFFFE =< C andalso C =< 16#EFFFF) orelse
        (16#FFFFE =< C andalso C =< 16#FFFFF) orelse
        (16#10FFFE =< C andalso C =< 16#10FFFF).
